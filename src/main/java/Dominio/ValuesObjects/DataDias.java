...
public class DataDias {
     ...
     */
         ...
         */
        public DataDias(int ano, int mes, int dia) {
            this.ano = ano;
            this.mes = mes;
            this.dia = dia;
        }
         ...
         */
        public boolean isMaior(DataDias outraData) {
            int totalDias = contarDias();
         ...
         *         parâmetro
         */
        public int calcularDiferenca(DataDias outraData) {
            int totalDias = contarDias();
            int totalDias1 = outraData.contarDias();
        ...
        public int calcularDiferenca(int ano, int mes, int dia) {
            int totalDias = contarDias();
            DataDias outraData = new DataDias(ano, mes, dia);
            int totalDias1 = outraData.contarDias();
